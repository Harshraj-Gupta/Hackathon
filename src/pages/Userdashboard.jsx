    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <aside className="w-64 bg-[#1742D2] text-white p-6 space-y-6">
        ...
        <nav className="space-y-2">
          <Link to='' className="flex items-center space-x-3 bg-white/10 text-white p-3 rounded-lg">
            <Home className="w-5 h-5" />
            <span>Dashboard</span>
          </Link>
          
          <Link to='/ExploreCourses' className="flex items-center space-x-3 hover:bg-white/10 p-3 rounded-lg transition-colors">
            <Compass className='w-5 h-5' />
            <span>Explore Courses</span>
          </Link>
          <Link href="#" className="flex items-center space-x-3 hover:bg-white/10 p-3 rounded-lg transition-colors">
            <Target className="w-5 h-5" />
            <span>My Roadmap</span>
          </Link>
          <Link to='https://www.w3schools.com/' className="flex items-center space-x-3 hover:bg-white/10 p-3 rounded-lg transition-colors z-10 relative hover:cursor-pointer">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {roleCourses.map((course) => (
                <div
                  key={course.id}
                  className="bg-white rounded-xl shadow-sm border border-gray-100 transform transition-all duration-300 hover:scale-105 mb-10 mt-5 "
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              ...
              <div className="mb-4">
                <div className="h-2 bg-gray-200 rounded-full">
                  <div 
                    className="h-2 bg-[#1742D2] rounded-full" 
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600">{progressData.nextLesson}</p>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-semibold text-gray-800">Upcoming Deadline</h3>
                <Calendar className="w-5 h-5 text-[#1742D2]" />
              </div>
              <p className="text-gray-600">{progressData.upcomingDeadline}</p>
              <button className="mt-4 text-[#1742D2] font-medium hover:underline">
                View Calendar →
              </button>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              <h3 className="font-semibold text-gray-800 mb-4">Daily Challenge</h3>
              <div className="bg-gray-50 rounded-lg p-4">
                <h4 className="font-medium text-gray-700">Build a React Component</h4>
                <p className="text-gray-600 mt-2">Create a reusable button component with different variants.</p>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              <h3 className="font-semibold text-gray-800 mb-4">Learning Resources</h3>
